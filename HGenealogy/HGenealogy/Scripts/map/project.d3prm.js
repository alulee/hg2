    ...
    "constraints": [
        {
            ...
            "has": { "name": "ETL process 1" },
            "type": "position",
            "x": 0.30,
            "weight": 0.7
        }, {
            "has": { "name": "ETL process 2" },
            "type": "position",
            "x": 0.45,
            "weight": 0.7
        }, {
            "has": { "name": "ETL process 4" },
            "type": "position",
            "x": 0.60,
            "weight": 0.7
        }, {
            "has": { "name": "ETL process 3" },
            "type": "position",
            "x": 0.75,
            "weight": 0.7
        }, {
            "has": { "name": "ETL process 5" },
            "type": "position",
            "x": 0.90,
            "weight": 0.7
        }, {
            ...
            "has": { "type": "report", "group": "Reporting" },
            "type": "position",
            "x": 0.9,
            "weight": 0.8
        }, {
            "has": { "type": "query", "group": "Data1" },
            "type": "position",
            "x": 0.15,
            "weight": 0.7
        }, {
            "has": { "type": "query", "group": "Data3" },
            "type": "position",
            "x": 0.2,
            "weight": 0.7
        }, {
            "has": { "type": "query", "group": "Data4" },
            "type": "position",
            "x": 0.2,
            "weight": 0.7
        }, {
            "has": { "type": "query", "group": "Data2" },
            "type": "position",
            "x": 0.5,
            "weight": 0.4
        }, {
            "has": { "type": "query", "group": "Validation" },
            "type": "position",
            "x": 0.8,
            "y": 0.7,
            "weight": 0.7
        }, {
            "has": { "type": "query", "group": "Miscellaneous" },
            "type": "position",
            "x": 0.9,
            "y": 0.5,
            "weight": 0.7
        }, {
            "has": { "type": "query", "group": "Management" },
            "type": "position",
            "x": 0.95,
            "weight": 0.7
        }, {
...
$(function () {
    ...
    //$.getJSON("Scripts/map/d3-prm/data/default/config.json")
    //    .done(function (data) {
    //        config1 = data;
    //        graph.data = jsonobj;
    //        drawGraph();
...
function drawGraph() {
    ...
    for (var name in graph.data) {
        ...
        for (var depIndex in obj.depends) {
            ...
            link.strength = (link.linkStrength || 1)
                          * (link.linkStrength || 1);
...
function tick(e) {
    ...
    graph.line
        .attr('x1', function (d) {
            return (d.source==null?0:d.source.x);
        })
        .attr('y1', function (d) {
            return (d.source==null?0:d.source.y);
        })
        .each(function (d) {
            var x = d.target.x,
                y = d.target.y,
                line = new geo.LineSegment((d.source==null?0:d.source.x), (d.source==null?0:d.source.y), x, y);
