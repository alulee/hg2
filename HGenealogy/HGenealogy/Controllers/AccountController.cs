...
namespace HGenealogy.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //
        // POST: /Account/EditCurrent
        [HttpPost]        
        [ValidateAntiForgeryToken]
        public ActionResult EditCurrentUser(EditUserViewModel myUser)
        {
            if (ModelState.IsValid)
            {
                using (var db = new ApplicationDbContext())
        ...
        // GET: /Account/Edit
        [Authorize(Roles = "Admin")]
        public ActionResult Edit(string id, HGenealogy.Controllers.ManageController.ManageMessageId? Message = null)
        {
            var Db = new ApplicationDbContext();
